...
func newPullRequest(ctx *clientContext, apiObj *interface{} /* *gostash.PullRequest */) *pullrequest {
	return &pullrequest{
		clientContext: ctx,
		pr:            *apiObj,
	}
...
type pullrequest struct {
	*clientContext
	...
	pr interface{} //gostash.PullRequest
}
...
func pullrequestFromAPI(apiObj *interface{} /* *gostash.PullRequest */) gitprovider.PullRequestInfo {
